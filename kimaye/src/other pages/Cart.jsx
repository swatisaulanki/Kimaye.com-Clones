...
return (
  <div>
      <Navbar/>
    <h1>CART</h1>
    <div className="ss" style={{display:"grid", gridTemplateColumns:"Repeat(2,1fr)", gap:"30px", marginLeft:"200px"}}>
    {swati.map(item => (
  <div className="card">
      ...
      <a href="#" onClick={()=>remove(item)} style={{boxShadow: "rgba(50, 50, 93, 0.25) 0px 30px 60px -12px inset, rgba(0, 0, 0, 0.3) 0px 18px 36px -18px inset", textDecoration:"none"}}>REMOVE</a>
